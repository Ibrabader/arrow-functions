...
console.log(sumAndPandArrow(3,9));
...
let messageA = name1=> `hello, ${name1}`

// TODO: Uncomment the following line of code to see the output in the browser console
console.log(message('Allie'));
console.log(messageA('Allie'));
...
Student.prototype.greetingG=() => `Hi, my name is ${this.name}`;
// TODO: Uncomment the following line of code to see the output in the browser console
// Note that the arrow function will cause this method to break!
console.log(joe.greetingG());
...
Student.courseNameNum=() =>'This student is enrolled in Code 301.';
// TODO: Uncomment the following line of code to see the output in the browser console
...
//undefined
// 2. What is "this" when joe.scopeArrow() is invoked?ll
// The Window Object// 3. Explain why "this" is different when an arrow function is used.
...
// because  normal functions always redefined  this in there scoop, unlike arrow function that refer to the class when used which is the best practice for reactjs